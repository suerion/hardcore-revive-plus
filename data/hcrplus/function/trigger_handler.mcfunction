...
execute as @a[scores={hcrplus_spawn_page2=1..}] if entity @s[tag=hcrplus_operator] run function hcrplus:settings/menus/spawn/page2
execute as @a[scores={hcrplus_spawn_page2=1..}] if entity @s[tag=!hcrplus_operator] run function hcrplus:settings/deny
scoreboard players set @a[scores={hcrplus_spawn_page2=1..}] hcrplus_spawn_page2 0

# Set HCRPlus Server Spawn
execute as @a[scores={hcrplus_set_server_spawn=1..}] at @s if entity @s[tag=hcrplus_operator] run function hcrplus:settings/menus/spawn/toggles/set_server_spawn
...
scoreboard players enable @a hcrplus_spawn_page2
