...
execute as @s[scores={Lives=5..}] if score mnc_settings mnc_lifeJam matches 1 run give @s totem_of_undying
execute as @s[scores={Lives=5..}] if score mnc_settings mnc_lifeJam matches 1 run title @s actionbar "You have reached the maximum amount of lives!"
execute as @s[scores={Lives=5..}] if score mnc_settings mnc_lifeJam matches 1 run tag @s remove lifeJam

# Add life
execute as @s[scores={Lives=..4}] if score mnc_settings mnc_lifeJam matches 1 run title @s actionbar "You have received another life!"
execute as @s[scores={Lives=..4}] if score mnc_settings mnc_lifeJam matches 1 run scoreboard players add @s Lives 1
