...
tellraw @s [" ",{"click_event":{"action":"run_command","command":"/trigger _hcrplus_settings set 1"},"color":"yellow","text":"<-- Return"},{"color":"gray","text":"      - 2/2 -      "},{"click_event":{"action":"run_command","command":"/trigger hcrplus_spawn_page1 set 1"},"color":"yellow","text":"Page 1 -->"},{"text":"\n "}]
