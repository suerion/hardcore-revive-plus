...
tellraw @s [" ",{"click_event":{"action":"run_command","command":"/trigger _hcrplus_settings set 1"},"color":"yellow","text":"<-- Return"},{"color":"gray","text":"      - 1/2 -      "},{"click_event":{"action":"run_command","command":"/trigger hcrplus_spawn_page2 set 1"},"color":"yellow","text":"Page 2 -->"},{"text":"\n "}]
