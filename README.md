...
The latest stable release is **v1.11.7** for **Minecraft 26.1.2** and **v1.12.1** for **Minecraft 26.2** and is available as both, a traditional datapack and as a datapack packaged inside a mod.
